            ...
            {({ open }) => (
                <>
                    <div className="mx-auto  px-2 sm:px-4 lg:divide-y lg:divide-gray-700 lg:px-8">
                            ...
                            <div className="relative z-0 flex flex-1 items-center justify-center px-2 sm:absolute sm:inset-0">
                                {SocialNavigation.map((item) => (
                                    <a key={item.name} href={item.href} className="text-gray-400 hover:text-gray-500">
                                        ...
                                        <item.icon className="m-4 h-6 w-6" aria-hidden="true" />
                                    </a>
                                ))}
                            </div>
                            ...
                            <div className="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center">
                                ...
                                <Menu as="div" className="relative ml-4 flex-shrink-0">
                                    ...
                                    >
                                        ...
                                        <Menu.Item>
                                                {() => (
                                                    <div className=" w-full  border-gray-800 block px-4 py-2 text-sm text-black">
                                                        {session ? (
                                                            <>
                                                                <p className='text-l font-bold'>{session.user.name}</p>
                                                            </>
                                                        ) : (
                                                            <>
                        ...
                        <div className="hidden lg:flex lg:space-x-8 lg:py-2" aria-label="Global">
                            {navigation.map((item) => (
                                <a
                                    key={item.name}
                                    href={item.href}
